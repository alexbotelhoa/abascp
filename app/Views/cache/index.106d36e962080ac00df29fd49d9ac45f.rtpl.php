                        ...
                        <table class="table no-margin">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/sitescp/tasks/<?php echo htmlspecialchars( $value1["idtask"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/situation/index" class="btn btn-success btn-xs"><i class="fa fa-folder-open"></i> Aberto </a>
                                    <?php }else{ ?>
                                    <a href="/sitescp/tasks/<?php echo htmlspecialchars( $value1["idtask"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/situation/index" class="btn btn-danger btn-xs"><i class="fa fa-folder"></i> Fechado</a>
                                    <?php } ?>
                                </td>
                            </tr>
                            <?php } ?>
...
<div class="brands-area">
                ...
                <div class="brand-wrapper">
                    ...
                    <?php $counter1=-1;  if( isset($projects) && ( is_array($projects) || $projects instanceof Traversable ) && sizeof($projects) ) foreach( $projects as $key1 => $value1 ){ $counter1++; ?>
                        ...
                        <?php } ?>
                            ...
                            <a href="/sitescp/projects/<?php echo htmlspecialchars( $value1["idproject"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/details" class="small-box-footer">Mais detalhes <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    <?php } ?>
                    </div>
                </div>
    ...
    <!-- jQuery 2.2.3 -->
    <script src="/abascp/res/site/plugins/jQuery/jquery-2.2.3.min.js"></script>

    <!-- ChartJS 1.0.1 -->
    <script src="/abascp/res/site/plugins/chartjs/Chart.min.js"></script>
